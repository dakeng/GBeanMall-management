...
const nodeEnvInfo = {
    ...
    usecdn: typeof process.env.USECDN === 'undefined' ? 0 : returnBool(process.env.USECDN),
    cdnnormal: typeof process.env.CDNNORMAL === 'undefined' ? 0 : returnBool(process.env.CDNNORMAL),
